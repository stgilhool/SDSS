...
; Get the feature which is to be the numerator
numerator = 0
ew_vec0 = ew_fit[numerator,*]
...
rmse = stddev(absk_model-absk_vec)

plot, absk_vec[aksort], ps = 6, title="Agreement between fit and data | RMSE = "+strtrim(rmse,2) + " magnitudes", xtit = "Spectrum", ytit = "M_K"
oploterror, absk_vec[aksort], eabsk_vec[aksort], ps=6
oplot, absk_vec[aksort], ps=6
...
plot, mean_chi, ps=6
oploterror, mean_chi+sig_chi, mean_chi-sig_chi
stop
