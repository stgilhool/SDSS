...
if corcntb gt 0 then ew_corr_xb = phistxb[corr_idxb] + bmin
if corcntg gt 0 then ew_corr_xg = phistxg[corr_idxg] + gmin
if corcntr gt 0 then ew_corr_xr = phistxr[corr_idxr] + rmin
