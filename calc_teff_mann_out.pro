; Calculate Teff based on Mann 2013 paper's PHOENIX model grid search
pro calc_teff_mann_out
...
outfile = '/home/stgilhool/APOGEE/teff_results/teff_mann_empirical.fits'
outstr = {rel1_idx:rel1_idx, $
          teff_rel1:teff1_copy, $
          rel2_idx:rel2_idx, $
          teff_rel2:teff2_copy}
