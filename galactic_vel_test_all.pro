...
lim3 = binomial_stat_errors(nvs3, nr3, 68d0)
 ...
 set_plot, 'ps'
 device, filename = 'galactic_vel_test_all.eps'
 device, /color, bits=8
...
lim3 = binomial_stat_errors(nvs3, nr3, 68d0)
 ...
 set_plot, 'ps'
 device, filename = 'galactic_wvel_test_all.eps'
 device, /color, bits=8
 device, xs = 13, ys= 8, /inches
 loadct, 13
...
;;; Plot V vs. U
 set_plot, 'ps'
 device, filename = 'galactic_vu_test_all.eps'
 device, /color, bits=8
 device, xs = 13, ys= 8, /inches
 loadct, 13
...
;;; Plot Vtot vs Vsini
 set_plot, 'ps'
 device, filename = 'galactic_vtot_vsini_test_all.eps'
 device, /color, bits=8
 device, xs = 13, ys= 8, /inches
 loadct, 13
...
;;; Plot each component vs Vsini
 set_plot, 'ps'
 device, filename = 'galactic_vels_vsini_test_all.eps'
 device, /color, bits=8
 device, xs = 13, ys= 8, /inches
 loadct, 13
...
td_d = (x_td/x_d)*(f_td/f_d)
 ...
 set_plot, 'ps'
 device, filename = 'galactic_thin_thick_all.eps'
 device, /color, bits=8
; device, xs = 13, ys= 8, /inches
 loadct, 13
...
help, outstr
dxstop
mwrfits, outstr, 'spacevelocity_all.fits', /create
print, "File written"
dxstop
 ...
 set_plot, 'ps'
 device, filename = 'galactic_thin_thick_vsini_all.eps'
 device, /color, bits=8
; device, xs = 13, ys= 8, /inches
 loadct, 13
...
dxstop
  ...
  set_plot, 'ps'
  device, filename = 'galactic_toomre_all.eps'
  device, /color, bits=8
...
lim1 = [double(nhotrot)/nhot*0.8, double(nhotrot)/nhot*1.2]
 ...
 set_plot, 'ps'
 device, filename = 'galactic_young_rotfrac_all.eps'
 device, /color, bits=8
 device, xs = 13, ys= 8, /inches
 loadct, 13
