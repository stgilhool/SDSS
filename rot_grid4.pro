...
vsini_vec = dindgen(10)*5 + 5d0
nvel=n_elements(vsini_vec)

chiarr = dindgen(napofiles, nteff, nfeh, nvel)
...
for afil = 0, napofiles-1 do begin
    ...
    foreach teff, pteff, teff_idx do begin
        ...
        for feh = 0, nfeh-1 do begin
            ...
            pspec_apo = interpol(pflux, pho_logwl, apo_logwl)
            pspec_norm = continuum_fit(dindgen(nxorig), pspec_apo)
            pho_spec = pspec_apo/pspec_norm
            ...
            for v = 0, nvel-1 do begin
                ...
                tell_spec = replicate(1d0, nxorig)
                obs = apo_spec[*,afil]
                err = apo_err[*,afil]
                err[0:npad-1] = 1d8
                err[-1*(npad):-1] = 1d8
                ...
                r = amoeba3(ftol, scale=scale, p0=guess, function_name='spec_fit', $
                            function_value=fval, nmax=3000, ncalls=ncalls)
    ...
    endforeach
    chi_int_out = reform(chiarr[afil,*,*,*],nteff,nfeh,nvel)
    outfile = '/home/stgilhool/APOGEE/APOGEE_data/results2/rfile'+strtrim(afil,2)+'.fits'
    mwrfits, chi_int_out, outfile, /create
    print, "Wrote file "+strtrim(afil,2)
endfor
outfile = '/home/stgilhool/APOGEE/APOGEE_data/results2/rfile_master.fits'
mwrfits, chiarr, outfile, /create
