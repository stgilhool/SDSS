...
for fnum = 0, nspec-1 do begin 
    ...
    f='/home/stgilhool/APOGEE/vsini_results/rfile'+strtrim(fnum,2)+'.fits'
    r = mrdfits(f,0)
    ...
    vsini = [4d0, 6d0, 10d0, 16d0, 24d0, 34d0, 46d0, 60d0]
    vsini_over = dindgen(225)/4d0 + 4d0
    nvel = n_elements(vsini)
    nvel_over = n_elements(vsini_over)
    
    nteff=20
    teff_vec = lindgen(nteff)*100+2000
...
;Write results
outfile = '/home/stgilhool/APOGEE/vsini_results/rfile_master.fits'
