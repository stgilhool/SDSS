...
pro vsini_kaniadakis_mydata, vis=vis
...
mydata_info = mrdfits('/home/stgilhool/APOGEE/master_info5.fits',1)
...
; here's where i change it to my data
vsini = mydata_info[sel_idx].vsini_vfit
...
save, /variables, filename='vsini_kan_mydata.sav'

plot_the_data:

restore, 'vsini_kan_mydata.sav'
