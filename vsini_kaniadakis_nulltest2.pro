...
pro vsini_kaniadakis_nulltest2, vis=vis
...
save, /variables, filename='vsini_kan_nulltest2.sav'

plot_the_data:

if skip_to_plot then restore, 'vsini_kan_nulltest2.sav'
...
set_plot, 'ps'
device, filename = 'vsini_kaniadakis_nulltest2.eps', /encapsulated
device, /color, bits=8
device, xs = 13, ys= 8, /inches
loadct, 13
...
; cgcontrol, output='cgkan_test.eps', IM_width=1000
 ...
 plot, teff_bin_vec_ctr, vsini_mean, ps=6, xtit = "Teff", ytit = "Peak Vsini", $
   tit=eq_string, charsize=2.5, xrange=[2600,3500], /xs
...
mwrfits, outstr, 'vsini_kaniadakis_nulltest2.fits', /create
