; Adding a cut on ASPCAP VSINI tags
...
pro vsini_kaniadakis_test3, vis=vis, thresh=thresh, vsini_0=vsini_0, kappa=kappa, sigma=sigma, result_mean=result_mean, result_stddev=result_stddev, std_err=std_err
