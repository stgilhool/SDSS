...
pro vsini_teff_direct_houdebine
...
p1 = plot(teff, vsini, xr=[2600,4000], yr= [0,30], xtit = 'Teff', ytit = 'Vsini',title = "ASPCAP Vsini vs. Teff color-coded by SNR, with Houdebine, et al. (2016) in blue", /nodata, /buffer)
...
;device, /close
stop
p1.save, "vsini_teff_snr_lit.eps"
stop
