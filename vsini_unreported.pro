...
for bin = 0, snr_diff_100-2 do begin
    ...
    vsini_samp = vsini_all[vnan_bin_idx]
    det_idx = where(vsini_samp gt 0, ndet, complement=nodet_idx, ncomplement=nnodet)
...
plot, snr_bin_ctr, nanfrac, ps=10, xtit = "SNR", ytit = "Fraction vsini that are NaN", charsize = 2

plot, snr_bin_ctr, nspec_vec, ps=10, xtit = "SNR", ytit = "Number of vsini measurements", charsize = 2, /ylog
